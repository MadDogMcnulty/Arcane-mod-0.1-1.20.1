...
public class GemstoneRefineryMenu extends AbstractContainerMenu {
    ...
    public GemstoneRefineryMenu(int pContainerId, Inventory inv, FriendlyByteBuf extraData) {
    ...
    public int getScaledProgress() {
        ...
        int progressArrowSize = 15; //Height in pixels of filling arrow
...
// actual mess I hate it basically all it does is make it so you can shift click things back and forth
